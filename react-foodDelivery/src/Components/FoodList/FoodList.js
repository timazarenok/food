...
class FoodList extends Component
{
    ...
    radioSelect = (selected) => {
        ...
        if(this.state.prevRestraunt.length > 0 && this.state.prevRestraunt !== this.state.selectedRestraunt)
        {
                                    ...
                                    return (
                                        <ListItem button key={item.id} >
                                            <Radio 
                                                ...
                                                aria-label="B"
                                            />
                                        <ListItemText inset primary={item.name} key={item.id} style={styles.itemText}/>
                                        <p key={item.id} >
                                           {item.price}/-
                                        </p>
                                        </ListItem>
