    ...
    render(){
        ...
        <div style={styles.divCounter}>
            <Button variant="outlined"   onClick={this.updateQuantity}>
                <FontAwesomeIcon icon="plus-circle" style={styles.color}/>
            </Button>
            <p>{this.props.quantity}</p>
            <Button variant="outlined" onClick={this.removeQuantity}>
                <FontAwesomeIcon icon="minus-circle"  style={styles.color}/>
            </Button>
        </div>
        );
    }
